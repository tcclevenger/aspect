...
\item {\it Parameter name:} {\tt Coarse level}
\phantomsection\label{parameters:Coarse level}
\label{parameters:Coarse_20level}


\index[prmindex]{Coarse level}
\index[prmindexfull]{Coarse level}
{\it Value:} 0
...
{\it Description:} For GMG, level at which we switch to AMG.
...
{\it Possible values:} An integer $n$ such that $0\leq n \leq 2147483647$
\item {\it Parameter name:} {\tt Use BFBT}
\phantomsection\label{parameters:Use BFBT}
\label{parameters:Use_20BFBT}


\index[prmindex]{Use BFBT}
\index[prmindexfull]{Use BFBT}
{\it Value:} false
...
{\it Description:} Use BFBT preconditioner?
