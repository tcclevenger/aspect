...
#ifndef _aspect_boundary_tangential_traction_function_h
#define _aspect_boundary_tangential_traction_function_h
...
namespace aspect
{
  namespace BoundaryTangentialTraction
  {
    ...
    /**
     * A class that implements the tangential traction boundary conditions based on a
    ...
    class Function : public Interface<dim>, public SimulatorAccess<dim>
    {
      ...
      private:
        /**
         * A function object representing the components of the tangential traction boundary.
         */
        Functions::ParsedFunction<dim> boundary_tangential_traction_function;
